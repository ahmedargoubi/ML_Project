...
g = sns.displot(data=telecom_cust, x='tenure', bins=int(180/5), color='darkblue', edgecolor='black')

# Set axis labels and title
g.set_axis_labels(y_var='# of Customers', x_var='Tenure (months)')
...
model_rf = RandomForestClassifier(n_estimators=1000, oob_score=True, n_jobs=-1,
                                  random_state=50, max_features='sqrt',  # Update this line
                                  max_leaf_nodes=30)
